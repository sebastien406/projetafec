...
<fieldset class="groupe-section">
    <legend><i class="fas fa-users"></i> Gestion des Membres</legend>
        ...
        <form action="#" method="POST" class="formulaire-gestion-groupe" enctype="multipart/form-data">
            ...
            <div class="groupe-bloc-avatar-nom">
                ...
                <div class="groupe-form-champ nom-du-groupe">
                    <label for="nom-groupe"><i class="fas fa-signature"></i> Nom du Groupe :</label>
            ...
            <fieldset class="groupe-section">
                ...
                <div class="groupe-liste-membres-attente">
                    ...
                    <div class="groupe-membre-item">
                        ...
                        <div class="groupe-actions">
                            <button type="button" class="bouton-action-groupe bouton-accepter"><i class="fas fa-check-circle"></i> Accepter</button>
                            <button type="button" class="bouton-action-groupe bouton-refuser"><i class="fas fa-times-circle"></i> Refuser</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="groupe-liste-membres">
                    ...
                    <div class="groupe-membre-item">
                        ...
                        <div class="groupe-actions">
                            <button type="button" class="bouton-action-groupe bouton-exclure"><i class="fas fa-user-slash"></i> Exclure</button>
                        </div>
                    </div>
                    <div class="groupe-membre-item">
            ...
            <fieldset class="groupe-section">
                <legend><i class="fas fa-camera"></i> Photos du Groupe</legend>
                ...
                <div class="groupe-form-champ">
                    <label for="upload-photos-rando" class="groupe-bouton-telechargement">
                        <i class="fas fa-upload"></i> Ajouter des photos de rando
                    </label>
            ...
            <fieldset class="groupe-section">
                <legend><i class="fas fa-calendar-alt"></i> Gestion des Randonnées</legend>
                ...
                <div class="groupe-liste-evenements">
                    ...
                    <div class="groupe-evenement-item">
                        ...
                        <button type="button" class="bouton-action-groupe"><i class="fas fa-edit"></i> Modifier</button>
                        <button type="button" class="bouton-action-groupe"><i class="fas fa-trash-alt"></i> Supprimer</button>
                    </div>
                </div>
                
                <button type="button" class="groupe-bouton-ajouter-rando"><i class="fas fa-plus-circle"></i> Ajouter une randonnée</button>
            </fieldset>
